    ...
    <table class="adminlist">
        <thead>
            <tr>
                ...
                <th width="5%">
                    <?php echo HTMLHelper::_('grid.sort', 'JGRID_HEADING_ORDERING', 'sp.ordering', $listDirn, $listOrder); ?>
                    <?php if ($saveOrder) :?>
                        <?php echo HTMLHelper::_('grid.order',  $this->items, 'filesave.png', 'sexypolls.saveorder'); ?>
                    <?php endif; ?>
                </th>
                <th width="5%">
        ...
        foreach ($this->items as $i => $item) :
            ...
            <tr class="row<?php echo $i % 2; ?>">
                ...
                <td align="center">
                    <a href="<?php echo Route::_('index.php?option=com_sexypolling&task=sexycategory.edit&id='.(int) $item->category_id); ?>">
                        <?php echo $item->category_title; ?>
                    </a>
                </td>
                <td align="center">
                    <a href="<?php echo Route::_('index.php?option=com_sexypolling&task=sexytemplate.edit&id='.(int) $item->template_id); ?>">
            ...
            <thead>
                <tr>
                    <th width="1%" class="nowrap center hidden-phone">
                        <?php echo HTMLHelper::_('grid.sort', '<i class="icon-menu-2"></i>', 'sp.ordering', $listDirn, $listOrder, null, 'asc', 'JGRID_HEADING_ORDERING'); ?>
                    </th>
